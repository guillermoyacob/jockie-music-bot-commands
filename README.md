...
### 📋 Guía rápida de comandos / Quick Command Guide
---
...
- `m!skip` | `m!s` ➔ Salta la canción actual.
- `m!queue` | `m!q` ➔ Muestra la lista de reproducción.
- `m!remove` ➔ Quita una canción específica.
- `m!clear` ➔ Limpia toda la lista.

### 🔍 Información y Utilidades
- `m!lyrics` ➔ Busca la letra de la canción.
- `m!save` ➔ Te envía la info de la canción por MD 📩.
...
### 🛠️ Queue Management
- `m!skip` | `m!s` ➔ Skip current song.
- `m!queue` | `m!q` ➔ Show current playlist.
- `m!remove` ➔ Remove a song from the list.
- `m!clear` ➔ Clear the entire queue.

### 🔍 Info & Utilities
- `m!lyrics` ➔ Find lyrics for the current song.
- `m!save` ➔ Save current song info to your DMs 📩.
